...
def prod(aseq,bseq):
    """
    Return the element-wise product of two sequences of equal length.
    >>> prod([1, 2, 3], [4, 5, 6])
    [4, 10, 18]
    """
    return [a*b for a,b in zip(aseq,bseq)]
...
def cumsum(s):
    """
    return the cumulative sum of the elements in the sequence s
    >>> cumsum([1, 2, 3])
    [1, 3, 6]
    """
    psum, cs = 0, []
